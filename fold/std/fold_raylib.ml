         ...
         [
           nif "init_window" (fun args ->
               ...
               | _ ->
                   Exception.throw e_bad_arg
                     "raylib/init_window expects int int string");
           ...
           nif "draw_text" (fun args ->
               ...
               | [|
                ...
                Value.Int a;
               |] ->
                   Raylib.draw_text (estr s) x y size
               ...
               | _ ->
                   Exception.throw e_bad_arg
                     "raylib/draw_text expects string int int int [int int int \
                      int]");
           nif "draw_int" (fun args ->
               match args with
               | [| Value.Int n; Value.Int x; Value.Int y; Value.Int size |] ->
                   Raylib.draw_text (string_of_int n) x y size
                     Raylib.Color.darkgray;
                   Value.Nil
               | _ ->
                   Exception.throw e_bad_arg
                     "raylib/draw_int expects int int int int");
           nif "draw_float" (fun args ->
               match args with
               | [| Value.Float f; Value.Int x; Value.Int y; Value.Int size |]
                 ->
                   Raylib.draw_text (string_of_float f) x y size
                     Raylib.Color.darkgray;
                   Value.Nil
               | _ ->
                   Exception.throw e_bad_arg
                     "raylib/draw_float expects float int int int");
           nif "set_target_fps" (fun args ->
               ...
               | [| Value.Int fps |] ->
                   ...
                   Value.Nil
               | _ ->
                   Exception.throw e_bad_arg "raylib/set_target_fps expects int");
           nif "get_frame_time" (fun _ ->
               Value.Float (Raylib.get_frame_time ()));
           nif "get_fps" (fun _ -> Value.Int (Raylib.get_fps ()));
           ns "shapes"
             [
               nif "draw_circle" (fun args ->
                   ...
                   |] ->
                       Raylib.draw_circle x y r
                         (Raylib.Color.create cr cg cb ca);
                       Value.Nil
                   ...
                   | _ ->
                       Exception.throw e_bad_arg
                         "raylib/shapes/draw_circle expects int int float [int \
                          int int int]");
               nif "draw_rect" (fun args ->
                   ...
                   | _ ->
                       Exception.throw e_bad_arg
                         "raylib/shapes/draw_rect expects int int int int [int \
                          int int int]");
               nif "draw_line" (fun args ->
                   ...
                   | _ ->
                       Exception.throw e_bad_arg
                         "raylib/shapes/draw_line expects int int int int int \
                          int int int");
             ];
           ns "input"
             [
               nif "is_key_down" (fun args ->
                   ...
                   | _ ->
                       Exception.throw e_bad_arg
                         "raylib/input/is_key_down expects int");
               nif "is_key_pressed" (fun args ->
                   ...
                   | _ ->
                       Exception.throw e_bad_arg
                         "raylib/input/is_key_pressed expects int");
               ...
               nif "is_mouse_down" (fun args ->
                   ...
                   | _ ->
                       Exception.throw e_bad_arg
                         "raylib/input/is_mouse_down expects int");
             ];
         ])
end
