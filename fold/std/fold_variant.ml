    ...
    NS.register heap reg
      (ns "std/variant" [
        ...
        nif "make" (fun args ->
          ...
          | _ -> Exception.throw e_bad_arg "variant/make expects int [value]");
        ...
        nif "is_variant" (fun args ->
          match args with
          | [| Value.Ptr addr |] ->
            Value.Int (if H.get_tag heap addr = Fold_core.Tag.variant then 1 else 0)
          | [| _ |] -> Value.Int 0
          | _ -> Exception.throw e_bad_arg "variant/is_variant expects 1 arg");
        ...
        nif "is_tag" (fun args ->
          ...
          | [| Value.Ptr addr; Value.Int t |] ->
            (match H.read heap addr 0 with
             ...
             | _ -> Exception.throw e_bad_object "variant/is_tag: bad object")
